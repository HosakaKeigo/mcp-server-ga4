 ...
 * アクティブユーザー取得ツール定義
 */
export function activeUsersTool(ga4Client: GA4Client): IMCPTool<typeof activeUsersParamsSchema> {
  return {
    name: 'get-active-users',
    description: 'Get active and new users metrics for a specific date range',
    schema: activeUsersParamsSchema,
